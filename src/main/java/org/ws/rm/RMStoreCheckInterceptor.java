...
public class RMStoreCheckInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    private String endpointIdentifier = "{https://quarkiverse.github.io/quarkiverse-docs/quarkus-cxf/test/ws-rm}org.ws.rm.WsrmHelloService.{https://quarkiverse.github.io/quarkiverse-docs/quarkus-cxf/test/ws-rm}WsrmHelloServicePort@cxf";
